...
<?php include "Dashboard/style/header.php"?>
        ...
        <div class="header">
            <div class="container-fluid">
               ...
               <?php
                        include 'Dashboard/fun/connection.php';
                        $stmt_slider=$coon->prepare("SELECT * FROM slider ");
                        $stmt_slider->execute();
                        while ($row_slider=$stmt_slider->fetch()) {
                            ?>
                            <div class="header-slider-item">
                                <img src="Dashboard/Photos/slider/<?php echo $row_slider['slider_img']?>" alt="Slider Image" style="width:250px" />
                                <div class="header-slider-caption">
                                    <p><?php echo $row_slider['slider_title']?></p>
        ...
        <div class="recent-product product">
            <div class="container-fluid">
                ...
                <div class="row align-items-center product-slider product-slider-4">
                <?php
                        $stmt_product=$coon->prepare("SELECT * FROM products ORDER BY ID DESC");
