                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="product-detail.php?id_product=<?php echo $row_product['id'] ?>"><?php echo $row_product['title_product']?></a>
                                        <div class="ratting">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <div class="product-action">
                                            <a href="product-detail.php?id_product=<?php echo $row_product['id'] ?>"><i class="fa fa-cart-plus"></i></a>
                                            <a href="#"><i class="fa fa-heart"></i></a>
                                            <a href="#"><i class="fa fa-search"></i></a>
                                        </div>
                                    </div>
                                    <div class="product-price">
                                        <h3><span>$</span><?php echo $row_product['price_product']?></h3>
                            ...
                            ?>
                                <div class="product-item">
                                    <div class="product-title">
                                        ...
                                        <a href="./roduct-detail.php"><?php echo $row_product['title_product']?></a>
                                        <div class="ratting">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
