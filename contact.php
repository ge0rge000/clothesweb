...
?>
    ...
    <form  action="Dashboard/fun/contactus/add_contact.php" method="POST">
    <div class="row">
        <div class="col-md-6">
            <input type="text" class="form-control" placeholder="Your Name" name="person" />
        </div>
        <div class="col-md-6">
    ...
    <div class="form-group">
        <input type="text" class="form-control" placeholder="mobilephone" name="mobilephone"/>
    </div>
    <div class="form-group">
